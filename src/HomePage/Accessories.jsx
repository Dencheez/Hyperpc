...
const Accessories = () => {
  ...
  return (
    <section className="py-24 bg-[#080808] border-t border-zinc-900 text-white" id="accessories">
      <div className="container mx-auto px-4 md:px-10">
        <h2 className="text-4xl md:text-5xl font-black italic uppercase tracking-tighter mb-12">Игровая <span className="text-cyan-500">Периферия</span></h2>
