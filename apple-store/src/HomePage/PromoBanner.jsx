      ...
      <div className="container mx-auto px-4 md:px-10">
        <div className="relative rounded-[3rem] overflow-hidden bg-[#0a0a0a] border border-white/5 p-10 md:p-24 group">
          ...
          <div className="relative z-10 max-w-2xl">
            <div className="inline-block px-4 py-1.5 rounded-full bg-cyan-900/30 border border-cyan-800 text-cyan-400 text-[10px] font-black uppercase tracking-widest mb-6">
               СЕЗОННАЯ АКЦИЯ
            </div>
            <h2 className="text-5xl md:text-8xl font-black text-white italic uppercase leading-[0.9] mb-8 tracking-tighter">
              Твой путь <br/>
              <span className="text-cyan-500">к победе</span>
            </h2>
            <p className="text-gray-400 text-lg mb-12 leading-relaxed max-w-lg">
              При покупке любого компьютера серии LUMEN или CYBER — профессиональная игровая гарнитура и коврик XL в подарок.
            </p>
            <button className="flex items-center gap-4 bg-white text-black font-black px-12 py-5 rounded-full uppercase tracking-widest text-xs hover:bg-cyan-400 transition-colors shadow-2xl hover:shadow-cyan-500/50">
