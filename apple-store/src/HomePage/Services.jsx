   ...
   return (
      <section id="services" className="py-20 bg-black border-t border-zinc-900">
         <div className="container mx-auto px-4 md:px-10">
            <h2 className="text-3xl font-black text-white italic uppercase tracking-tighter mb-10">Услуги <span className="text-gray-600">Сервиса</span></h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               {services.map((s, i) => (
                  <div key={i} className={`p-8 rounded-[2rem] bg-gradient-to-br ${s.bg} to-zinc-900 border border-zinc-800 hover:border-white/20 transition-all cursor-pointer group`}>
                      <h3 className="text-2xl font-black text-white italic uppercase mb-3">{s.title}</h3>
